class DeckValidator
  ...
  def check_basic_deckbuilding_rules
    ...
    if @deck['side_id'] == 'corp'
      ...
      agenda_points = agendas_with_points.map{|card_id, points| points * @deck['cards'][card_id] }.sum
    ...
    influence_spent = out_of_faction_cards.map{|card_id, influence| influence * @deck['cards'][card_id] }.sum
