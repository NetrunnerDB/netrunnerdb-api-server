...
ActiveRecord::Schema[7.2].define(version: 2025_07_29_152732) do
  ...
  create_table "cards", id: :string, force: :cascade do |t|
    ...
    t.boolean "has_gain_click", default: false
